...
package com.flexcapacitor.views {
	...
	public class Stats extends Sprite {	
		...
		/**
		 * How often to update the graph. default is 1 second (1000)
		 * */
		...
		/**
		 * Increases or decreases the stage framerate depending on where you click on graph (top or bottom) 
		 * */
