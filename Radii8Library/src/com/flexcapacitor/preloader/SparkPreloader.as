...
package com.flexcapacitor.preloader
{
...
import mx.preloaders.ErrorText;
 ...
 */
public class SparkPreloader extends Sprite implements IPreloaderDisplay
{
    ...
    {
        super();
		ErrorText.downloadProgressBar = this;
		//ErrorText.show("SPARK PRELOADER");
    }
    ...
    {
		ErrorText.show("1 SparkPreloader set visible");
        if (!_visible && value) 
            show();
    ...
    {
		ErrorText.show("2 SparkPreloader");
        _preloader = value;
    ...
    {
        _startTime = getTimer();
		ErrorText.show("3 SparkPreloader initialize");
    }
    ...
    {       
		ErrorText.show("4 SparkPreloader");
		...
		ErrorText.show("5 SparkPreloader");
    }
    ...
    {
		ErrorText.show("6 SparkPreloader");
		...
		ErrorText.show("6.1 SparkPreloader");
    }
    ...
    {
		ErrorText.show("7 SparkPreloader");
        if (!_barFrameSprite)
            return;
		...
		ErrorText.show("7.1 SparkPreloader");
    }
    ...
    {
		ErrorText.show("8 SparkPreloader show()");
        ...
        createChildren();
		ErrorText.show("8.1 SparkPreloader show()");
		ErrorText.show("8.2 SparkPreloader stageWidth:"+stageWidth);
    }
    ...
    {
		ErrorText.show("9 SparkPreloader");
    }
    ...
    {
		//ErrorText.show("10 SparkPreloader showDisplayForDownloading");
...
//        trace("showDisplayForDownloading:" + event.bytesLoaded + " " +  event.bytesTotal + " " +  (event.bytesLoaded < event.bytesTotal / 2));
    ...
    {
		ErrorText.show("11 SparkPreloader");
//        trace("showDisplayForInit: elapsedTime = " + elapsedTime + " count = " + count);
    ...
    {
		ErrorText.show("12 SparkPreloader");
        var cls:Class;
		...
		ErrorText.show("12.1 SparkPreloader");
    }
    ...
    {
		ErrorText.show("13 SparkPreloader");
        addChildAt(image,0);
		...
		ErrorText.show("13.1 SparkPreloader");
    }
    ...
    {   
		ErrorText.show("14 SparkPreloader");
    ...
    {
		ErrorText.show("15 SparkPreloader progressHandler()");
        ...
        if (!_showingDisplay && showDisplayForDownloading(elapsedTime, event)) {
			...
			ErrorText.show("15.1 SparkPreloader progressHandler()");
            show();
			ErrorText.show("15.2 SparkPreloader progressHandler()");
		}
            
        if (_showingDisplay) {
			ErrorText.show("15.3 SparkPreloader progressHandler()");
            setDownloadProgress(event.bytesLoaded, event.bytesTotal);
			ErrorText.show("15.4 SparkPreloader progressHandler()");
		}
    }
    ...
    {
		ErrorText.show("16 SparkPreloader completeHandler");
    }
    ...
    {
		ErrorText.show("17 SparkPreloader");
    }
    ...
    protected function rslCompleteHandler(event:RSLEvent):void
    {
		...
		ErrorText.show("18 SparkPreloader");
		ErrorText.show("rsl " + event.rslIndex + " of " + event.rslTotal);
    }
    ...
    protected function rslErrorHandler(event:RSLEvent):void
    {
		...
		ErrorText.show("19 SparkPreloader");
        
		ErrorText.show(event.errorText);
    }
    ...
    {
		ErrorText.show("20 SparkPreloader initProgressHandler()");
        ...
        if (_showingDisplay)
        {
			ErrorText.show("20.2 SparkPreloader initProgressHandler()");
		...
		ErrorText.show("20.3 SparkPreloader initProgressHandler()");
        }
		ErrorText.show("20.1 SparkPreloader initProgressHandler()");
    }
    ...
    {
		ErrorText.show("21 SparkPreloader");
        dispatchEvent(new Event(Event.COMPLETE));
		ErrorText.show("21.1 SparkPreloader"); 
    }
    ...
    {
        // Swallow the error
		ErrorText.show("23 SparkPreloader");
    }
